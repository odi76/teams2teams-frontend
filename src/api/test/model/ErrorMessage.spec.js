...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Teams2TeamsApiPrototype.ErrorMessage();
  });
  ...
  describe('ErrorMessage', function() {
    it('should create an instance of ErrorMessage', function() {
      ...
      //var instane = new Teams2TeamsApiPrototype.ErrorMessage();
      //expect(instance).to.be.a(Teams2TeamsApiPrototype.ErrorMessage);
    });
